...
### Новые функции ⭐
- **👥 Многопользовательские звонки**: Поддержка 3+ участников через SFU сервер
- **💬 Текстовый чат**: Обмен сообщениями в реальном времени
- **📎 Вложения файлов**: Отправка файлов до 50MB (изображения, документы, архивы)
- **🖥️ Демонстрация экрана**: Показ экрана другим участникам
- **↩️ Ответы на сообщения**: Reply функциональность в чате
- **✏️ Редактирование**: Редактирование и удаление своих сообщений
...
- ✅ Соберет все контейнеры
- ✅ Запустит все сервисы (включая SFU)
...
```bash
# Запустите все контейнеры (включая SFU)
