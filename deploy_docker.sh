...
# Полный скрипт развертывания с использованием Docker контейнеров

echo "🚀 Starting full deployment with Docker..."
