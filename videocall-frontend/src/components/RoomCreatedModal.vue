  ...
  <div class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
    <div class="card w-full max-w-lg p-6 animate-slide-up">
      <div class="text-center mb-6">
        ...
        <h3 class="text-xl font-semibold text-warp-text">Room Created!</h3>
        <p class="text-warp-muted mt-2">Share the link or code to invite others</p>
      </div>
      ...
      <div class="mb-6">
        ...
        <div class="flex items-center space-x-2">
          <div class="code-badge flex-1 justify-center text-base">
            {{ room.short_code }}
          </div>
      ...
      <div class="mb-6">
        ...
        <div class="flex items-center space-x-2">
          <input :value="room.room_url" readonly class="input-field flex-1 text-xs" />
      ...
      <div class="mb-6 text-center">
        <p class="text-sm font-medium text-warp-muted mb-3">QR Code</p>
      ...
      <!-- Room Info -->
      <div class="mt-6 pt-4 border-t border-warp-border text-center">
